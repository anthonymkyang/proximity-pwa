...
export function GroupDetailMap({ lat, lng, name }: GroupDetailMapProps) {
    ...
    const initMap = async () => {
      try {
        ...
        map.on("load", () => {
          ...
          el.className =
            "flex items-center justify-center rounded-full bg-red-600 text-white shadow-lg ring-4 ring-red-200";
          el.style.width = "40px";
  ...
  return (
    <>
      <div className="relative w-full rounded-xl overflow-hidden border bg-muted/20">
        {loading && (
